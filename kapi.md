...
[//]: # (TODO: table is in-progress, and need to add example responses)
...
| `/identifiers/{name}/registries` | GET    |                    | List credential issuance and revocation registies                                      |                                                                          | `200`: array of current credential issuance and revocation registies                                                                                                                                                                 |
